                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.kana" class="text-sm text-red-600">{{ errors.kana }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.tel" class="text-sm text-red-600">{{ errors.tel }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.email" class="text-sm text-red-600">{{ errors.name }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.postcode" class="text-sm text-red-600">{{ errors.postcode }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.address" class="text-sm text-red-600">{{ errors.address }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.birthday" class="text-sm text-red-600">{{ errors.name }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.is_selling" class="text-sm text-red-600">{{ errors.is_selling }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <div v-if="errors.memo" class="text-sm text-red-600">{{ errors.memo }}</div>
                                            </div>
                                        </div>
